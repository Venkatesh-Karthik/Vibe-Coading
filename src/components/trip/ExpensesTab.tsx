...
export default function ExpensesTab({ tripId, budget }: ExpensesTabProps) {
        ...
        >
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1 text-center">{percentSpent.toFixed(1)}% of budget used</p>
            </div>
          </div>
        </motion.div>
            ...
            return (
              ...
              >
                ...
                <div className="text-right ml-4">
                  <div className="text-lg font-bold text-slate-900">₹{expense.amount.toLocaleString()}</div>
      ...
      >
        ...
        <div className="space-y-3">
          {Object.entries(balances).map(([userId, balance]) => {
            ...
            return (
              <div key={userId} className="flex items-center justify-between p-4 rounded-xl bg-white/60">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-600">{balance > 0 ? "Gets back" : "Owes"}</div>
                  </div>
                </div>
