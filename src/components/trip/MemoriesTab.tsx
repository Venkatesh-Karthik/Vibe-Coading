    ...
    <div className="space-y-6">
      ...
      >
        <div className="border-2 border-dashed border-white/40 rounded-2xl p-12 text-center hover:border-sky-500/50 transition cursor-pointer">
          <motion.div whileHover={{ scale: 1.05 }} className="flex flex-col items-center gap-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-slate-900 mb-1">Upload Photos & Videos</h3>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-semibold">All Memories ({memories.length})</h2>
        ...
        {memories.length === 0 ? (
          <div className="glass-panel p-12 text-center">
            ...
            <p className="text-slate-500 text-sm">Start uploading photos to create your travel story</p>
          </div>
        ) : (
          ...
          >
            ...
            >
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <button onClick={() => setSelectedMemory(null)} className="p-2 rounded-lg hover:bg-white/50 transition">
                  <X className="h-5 w-5" />
                </button>
              </div>
