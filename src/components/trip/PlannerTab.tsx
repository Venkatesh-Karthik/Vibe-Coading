...
export default function PlannerTab({ tripId, startDate, endDate }: PlannerTabProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        {activitiesByDay[selectedDay] && activitiesByDay[selectedDay].length > 0 ? (
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <div className="text-right">
                          <div className="text-sm font-semibold text-slate-900">₹{activity.cost}</div>
          ...
          <div className="glass-panel p-12 text-center">
            ...
            <p className="text-slate-500 text-sm mb-4">Add activities to build your perfect itinerary</p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
      ...
      >
        ...
        <div className="glass-panel p-4 text-center">
          <div className="text-2xl font-bold gradient-text">{Object.keys(activitiesByDay).length}</div>
